...
Author: Akshaya Vinod Kumar | HCL GUVI Data Science Capstone
"""
import os
...
DATA_PATH = os.path.join(APP_DIR, "..", "data", "amazon_music_clustered_output.csv")
...
st.divider()
st.caption("Akshaya Vinod Kumar — Marine Biologist & Data Science Practitioner | HCL GUVI Data Science with ML & AI Certification")
